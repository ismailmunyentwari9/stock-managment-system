	...
	<div class="contents">
      ...
      <table>
      	...
      	<?php 
             ...
             $id=$_GET['delete'];
             $ans=mysqli_query($conn,"DELETE FROM food where food_id='$id'");

             	$ans=mysqli_query($conn,"SELECT * FROM food");
      	 ...
      	 <tr>
      	 	...
      	 	<td><?php echo $row['food_owner']?></td>
      	 	 <td><a href="viewfood.php?delete=<?php echo $row['food_id']?>">DELETE</a></td>
      	 	 <td><a href="editfood.php?edit=<?php echo $row['food_id']?>">EDIT</a></td>
      	 	 <td><a href="import.php?import=<?php echo $row['food_id']?>">IMPORT</a></td>
