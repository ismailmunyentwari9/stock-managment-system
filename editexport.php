...
<center>
      	...
      	<?php 
             ...
             $id=$_GET['editexport'];
             $ans=mysqli_query($conn,"SELECT * FROM  export where e_id='$id'");
	...
	<form method="POST">
	 ...
	 <div  class="form">Editing Exports</div>
	 <hr>
	 <input type="number" name="e_id" value="<?php echo $row['e_id']?>" readonly=""><br>
	  <input type="number" name="food_id" value="<?php echo $row['food_id']?>" readonly=""><br>
	  <input type="text" name="exportdate" value="<?php echo $row['exportdate']?>" ><br>
...
if (isset($_POST['submit'])) {
	...
	$ans=mysqli_query($conn,"UPDATE export SET exportdate='$date',quantity='$quantity' WHERE e_id='$code'");
