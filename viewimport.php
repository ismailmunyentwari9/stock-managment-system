	...
	<div class="contents">
      ...
      <table>
      	...
      	<?php 
             ...
             $id=$_GET['delete'];
             $ans=mysqli_query($conn,"DELETE FROM import where i_id='$id'");

             	$ans=mysqli_query($conn,"SELECT * FROM import");
      	 ...
      	 <tr>
      	 	...
      	 	<td><?php echo $row['quantity']?></td>
      	 	 <td><a href="viewimport.php?delete=<?php echo $row['i_id']?>">DELETE</a></td>
      	 	 <td><a href="editimport.php?editimport=<?php echo $row['i_id']?>">EDIT</a></td>
      	 	 <td><a href="export.php?export=<?php echo $row['food_id']?>">Export</a></td>
